		...
		<a href={href}>
			...
			>
				...
				<motion.div
					ref={ref}
					style={{ width }}
					className="bg-glass border-border flex aspect-square w-10 items-center justify-center rounded-full border shadow-inner shadow-white/0.5 backdrop-blur-2xl duration-100 active:scale-90"
				>
					<Icon
						strokeWidth="1.5"
