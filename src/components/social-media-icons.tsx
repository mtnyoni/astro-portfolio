export function SocialMediaIcons() {
	return (
		<div className="fixed top-1/2 left-24 hidden -translate-1/2 space-y-4 lg:block">
			<a
				href="https://github.com/mtnyoni"
				target="_blank"
				rel="noopener noreferrer"
				className="bg-background block size-12 rounded-full border border-mist-300 p-3"
			>
				<GithubIcon />
			</a>
			<a
